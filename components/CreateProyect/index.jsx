  ...
  return (
    ...
    >
      ...
      <hr className=" h-[3px] flex bg-slate-300 border-[1px] w-8/12 " />
      {
        ...
        <div className="sticky w-8/12 top-0 mt-1 z-20 bg-box-color flex flex-col items-center font-bold gap-4 p-4 rounded-lg text-xl">
          <div className="flex flex-wrap p-1 z-20 gap-4 justify-center">
            <>
              {
                confirmation.INFO_PROJECT &&
                <ComponentButton
                  buttonStyle="w-min h-min sm:h-6 text-sm"
          ...
          {
            !(confirmation.INFO_PROJECT && confirmation.BUDGET && confirmation.ASSEMBLE_TEAM) &&
            <div className="w-full flex flex-col font-bold gap-4 p-4 rounded-lg text-xl">
